...
function JobCardMercor({ job, onClick }: { job: Job; onClick: () => void }) {
  return (
    ...
    >
      {/* 公司 Logo/首字母 */}
      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center text-white text-lg font-bold mb-4">
      ...
      <div className="pt-4 border-t border-gray-100">
        <div className="flex items-center justify-between text-sm font-medium text-gray-900 group-hover:text-blue-600 transition-colors">
          <span>查看详情</span>
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-8 py-6 flex items-start justify-between">
          <div className="flex-1 pr-8">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center text-white text-xl font-bold">
                {job.companyName.charAt(0)}
              </div>
              <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-3 py-1.5 bg-green-50 text-green-700 text-sm font-medium rounded-lg flex items-center gap-1.5">
